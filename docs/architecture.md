...
| 快速添加：解析链接 | `Views/Components/ParseInfoView.swift`、`Views/Components/ParsePlatform/*` | 页面只编排解析、预览和字段勾选；路由、网络、结果模型与各平台解析器独立。当前注册大麦与猫眼，不修改 iOS 解析器 |
